...
//    }
    ...
    public Response<ErrorResponse> handleRequestForbiddenRequest(AccessDeniedException accessDeniedException, Locale locale) {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public Response<ErrorResponse> handleMethodNotSupportedException(IllegalArgumentException illegalArgumentException, Locale locale) {
